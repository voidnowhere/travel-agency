<x-home.layout :load-jquery="true">
    <div class="flex justify-center items-center grow sm:grow-0">
        <form method="post" id="register_form" class="px-0 sm:px-5 pt-4 sm:pt-5 pb-2 shadow-lg rounded-lg bg-blue-100">
            @csrf
            ...
            <x-form.recaptcha_invisible label="Register" form-id="register_form"/>
        </form>
    </div>
